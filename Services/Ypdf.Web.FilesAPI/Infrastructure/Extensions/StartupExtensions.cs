...
public static class StartupExtensions
{
    ...
    public static IServiceCollection AddCommands(this IServiceCollection services)
    {
        ...
        return services
            .AddScoped<ICommand<CheckOutputFileExistsRequest, CheckOutputFileExistsResponse>, CheckOutputFileExistsCommand>()
            .AddScoped<ICommand<GetOutputFileRequest, GetOutputFileResponse>, GetOutputFileCommand>()
            .AddScoped<IProtectedCommand<SaveFilesRequest, SaveFilesResponse>, SaveFilesCommand>();
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(services, nameof(services));
        return services.AddScoped<SavedFileRabbitMqProducer>();
    }
